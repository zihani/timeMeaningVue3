...
(function () {
    ...
    var toggleFullscreen = function (editor, fullscreenState) {
      ...
      if (!fullscreenInfo) {
        ...
        document.getElementsByClassName("tox-tinymce")[0].className = "tox tox-tinymce tox-height"
        keyindex = 1
    ...
    var register = function (editor, fullscreenState) {
      var onAction = function (value) {
        ...
        if(keyindex === 1 ){
          document.getElementsByClassName("tox-tinymce")[0].className = "tox tox-tinymce"
          keyindex = 2
          return editor.execCommand('mceFullScreen');
        }
      };
